package Q3;
/**
 * This class represents the Update operation in the database engine
 * @author Gokce Nur Erer
 */
public class UpdateOperation implements IDatabaseOperation {
    /**
    ...
    public boolean execute(Database database) {
        ...
        System.out.println("Updating the row " + col + " at table " + tableName + " in database " + database.name);
    ...
    public void unexecute() {
        System.out.println("Unexecuting update operation");
    }

    /**
     * Creates a string representation of an UpdateOperation object.
     * @return String representation of an UpdateOperation object.
     */
    @Override
