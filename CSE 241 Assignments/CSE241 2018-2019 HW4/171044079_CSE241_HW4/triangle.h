...
class Triangle{
	public:
		...
		void setTrianglePerimeter(double side);
		void setTriangleArea(double side);

		inline double getTrianglePerimeter() const { return perimeter; }
		inline double getTriangleArea() const { return area; }
		//Overloads for comparing two triangles respect to their areas
		...
		//Overload for printing a triangle object to the screen
